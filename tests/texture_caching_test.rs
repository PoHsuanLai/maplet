...
mod texture_caching_tests {
    ...
    fn test_texture_name_generation() {
        ...
        assert_eq!(
            hash1, hash2,
            "Identical tile data should generate identical texture names"
        );

        // Different data should generate different hash
        assert_ne!(
            hash1, hash3,
            "Different tile data should generate different texture names"
        );
        ...
        assert_eq!(
            name1, name2,
            "Texture names should be stable for identical data"
        );
    }
    ...
    fn test_bounds_affect_hash() {
        ...
        assert_ne!(
            hash1, hash2,
            "Different bounds should generate different hashes"
        );
    }
